...
def get_apoint():
    ...
    if len(a)==0:
        ...
        L6.place(x=50,y=350)
        l6=Label(root3,text=i[5])
        l6.place(x=150,y=140)
        ...
        L7=Label(root3,text=('Enter date:')).place(x=50,y=400)
        x3=tkinter.Entry(root3)
        x3.place(x=150,y=400)

        L8=Label(root3,text=('Enter time:')).place(x=50,y=430)
        x4=tkinter.Entry(root3)
        x4.place(x=150,y=430)
...
def pre_data():
    root.destroy()
#     sys.path.append('./main_project.ipynb')
...
b1=Button(root,text="Registration",font="arial 20 bold",bg='yellow',command=register)
b2=Button(root,text="Appointment",font="arial 20 bold",bg='yellow',command=apoint)
b3=Button(root,text="List of Doctors",font="arial 20 bold",bg='yellow',command=lst_doc)
b4=Button(root,text="Services available",font='arial 20 bold',bg='yellow',command=ser_avail)
b7=Button(root,text="View data",font='arial 20 bold',bg='yellow',command=search_data)
b5=Button(root,text="Modify ",font='arial 20 bold',bg='yellow',command=mod_sub)
b8=Button(root,text="Prescription ",font='arial 20 bold',bg='yellow',command=pre_data)
